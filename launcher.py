...
''')
    ...
    parser.add_argument("-s", "--save", action='store_true', help="Save the provided options except for the inputs, so that they become the new defaults.")
